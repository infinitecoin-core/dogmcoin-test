...
- ThreadSocketHandler : Sends/Receives data from peers on port 22171.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 22172 for connections and services them.

- DogmcoinMiner : Generates dogmcoins (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:dogmcoin/dogmcoin.git
