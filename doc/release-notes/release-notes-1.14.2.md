Dogmcoin Core version 1.14.2 is now available from:

  <https://github.com/dogmcoin/dogmcoin/releases/tag/v1.14.2/>
...
Dogmcoin Core introduces pruning the blockchain in 1.14. Pruning
...
When Dogmcoin Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Dogmcoin-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Dogmcoin Core. This was added in conjunction with
