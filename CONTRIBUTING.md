# Contributing to Dogmcoin Core

Dogmcoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/dogmcoin/dogmcoin/labels/help%20wanted)
* [Projects](https://github.com/dogmcoin/dogmcoin/projects)
* [Dogmcoindev on reddit](https://www.reddit.com/r/dogmcoindev/)

## Branch Strategy

Dogmcoin Core's default branch is intentionally a stable release, so that anyone
...
Dogmcoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Dogmcoin Core
releases will automatically benefit from these.

When refactoring Dogmcoin-specific code, please keep refactoring requests short,
low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Dogmcoin Core, and is not to be
confused with overall Dogmcoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Dogmcoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Dogmcoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Dogmcoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Dogmcoin consensus, it must have been
