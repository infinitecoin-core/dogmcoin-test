...
/** Recommended transaction fee by Dogmcoin Core developers
  *
...
/**
 * Dogmcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Dogmcoin: Default hard dust limit that is evaluated when considering whether
