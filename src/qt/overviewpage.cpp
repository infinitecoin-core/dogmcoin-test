...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, checkout Dogmcoin repository on GitHub!"),
        tr("Services that claim to double your dogmcoins are always ponzi schemes")
    };
