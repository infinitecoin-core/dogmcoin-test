...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dogmcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dogmcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dogmcoin transaction") + "\n" +
              "  dogmcoin-tx [options] -create [commands]   " + _("Create hex-encoded dogmcoin transaction") + "\n" +
              "\n";
