...
public:
    CMainParams() {
        ...
        D10AuxpowChainIdConsensus.nHeightEffective = 14557600;
        ...
        vSeeds.push_back(CDNSSeedData("spools.online", "dnsseed.spools.online", true));
        vSeeds.push_back(CDNSSeedData("spools.online", "dnsseed2.spools.online"));
        vSeeds.push_back(CDNSSeedData("spools.online", "dnsseed3.spools.online"));
        vSeeds.push_back(CDNSSeedData("aikapool.com", "dnsseed.aikapool.com", true));
        vSeeds.push_back(CDNSSeedData("aikapool.com", "dnsseed2.aikapool.com"));
        vSeeds.push_back(CDNSSeedData("aikapool.com", "dnsseed3.aikapool.com"));
        vSeeds.push_back(CDNSSeedData("zalmex.online", "dnsseed.zalmex.online", true));
        vSeeds.push_back(CDNSSeedData("zalmex.online", "dnsseed2.zalmex.online"));
        vSeeds.push_back(CDNSSeedData("zalmex.online", "dnsseed3.zalmex.online"));
        vSeeds.push_back(CDNSSeedData("amxpool.com", "dnsseed.amxpool.com", true));
        vSeeds.push_back(CDNSSeedData("amxpool.com", "dnsseed2.amxpool.com"));
        vSeeds.push_back(CDNSSeedData("amxpool.com", "dnsseed3.amxpool.com"));
        vSeeds.push_back(CDNSSeedData("coinxpool.com", "dnsseed.coinxpool.com", true));
        vSeeds.push_back(CDNSSeedData("coinxpool.com", "dnsseed2.coinxpool.com"));
        vSeeds.push_back(CDNSSeedData("coinxpool.com", "dnsseed3.coinxpool.com"));
        vSeeds.push_back(CDNSSeedData("zapto.org", "dnsseed.zapto.org", true));
        vSeeds.push_back(CDNSSeedData("zapto.org", "dnsseed2.zapto.org"));
        vSeeds.push_back(CDNSSeedData("zapto.org", "dnsseed3.zapto.org"));
        vSeeds.push_back(CDNSSeedData("poolmz.online", "dnsseed.poolmz.online", true));
        vSeeds.push_back(CDNSSeedData("poolmz.online", "dnsseed2.poolmz.online"));
        vSeeds.push_back(CDNSSeedData("poolmz.online", "dnsseed3.poolmz.online"));
        vSeeds.push_back(CDNSSeedData("hyperdonkey.com", "dnsseed.hyperdonkey.com", true));
        vSeeds.push_back(CDNSSeedData("hyperdonkey.com", "dnsseed2.hyperdonkey.com"));
        vSeeds.push_back(CDNSSeedData("hyperdonkey.com", "dnsseed3.hyperdonkey.com"));
        vSeeds.push_back(CDNSSeedData("flyhash.xyz", "dnsseed.flyhash.xyz", true));
        vSeeds.push_back(CDNSSeedData("flyhash.xyz", "dnsseed2.flyhash.xyz"));
        vSeeds.push_back(CDNSSeedData("flyhash.xyz", "dnsseed3.flyhash.xyz"));
        vSeeds.push_back(CDNSSeedData("ifcf2pool.com", "dnsseed.ifcf2pool.com", true));
        vSeeds.push_back(CDNSSeedData("ifcf2pool.com", "dnsseed2.ifcf2pool.com"));
        vSeeds.push_back(CDNSSeedData("ifcf2pool.com", "dnsseed3.ifcf2pool.com"));
        vSeeds.push_back(CDNSSeedData("zpool.ca", "dnsseed.zpool.ca", true));
        vSeeds.push_back(CDNSSeedData("zpool.ca", "dnsseed2.zpool.ca"));
        vSeeds.push_back(CDNSSeedData("zpool.ca", "dnsseed3.zpool.ca"));
