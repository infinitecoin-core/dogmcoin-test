...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 DOGM from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 dogm in block rewards plus fees, but
        ...
        # Send 100000 DOGM with subtract fee from amount
