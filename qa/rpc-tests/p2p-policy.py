...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Dogmcoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in DOGM
        ten = Decimal("10.0")                  # uniform 10 DOGM seed moneys
        ...
        # create a bunch of UTXO with seed money from the Dogmcoin Core wallet
        for i in range(10):
        ...
        # test legacy output of 1 DOGM output and 1 DOGM fee
    ...
    # spend seed money with a key not in the Dogmcoin Core wallet.
    def spend_utxo(self, output):
        # construct the transaction using Dogmcoin Core raw tx APIs
        ...
        # and send the tx from there rather than from Dogmcoin Core, to test
